using BinaryProvider # requiert BinaryProvider 0.3.0 or supérieur

# Analyse d'arguments de ligne de commande de base
...
elseif unsatisfied
    ...
    error("Votre OS $(triplet(platform_key())) n'est pas prise en charge par ce paquet!")
end
